...
`)
	...
	sb.WriteString("\nOutput ONLY the PRD content in Markdown format. Start directly with the project title as a level-1 heading. Do not include any explanations or meta-commentary.\n")
